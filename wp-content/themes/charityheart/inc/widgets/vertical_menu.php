...
class Charityheart_Vertical_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_vertical_menu',
            esc_html__('Apus Vertical Menu Widget', 'charityheart'),
            array( 'description' => esc_html__( 'Show Vertical Menu', 'charityheart' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <select name="<?php echo esc_attr($this->get_field_name( 'nav_menu' )); ?>" id="<?php echo esc_attr($this->get_field_id( 'nav_menu' )); ?>">
                <option value="" <?php selected( $instance['nav_menu'], $menu->slug ); ?>> <?php esc_html_e('--- Select Menu ---', 'charityheart'); ?></option>
        ...
        <p>
            ...
            <select name="<?php echo esc_attr($this->get_field_name( 'position' )); ?>" id="<?php echo esc_attr($this->get_field_id( 'position' )); ?>">
                <option value="left" <?php selected( $instance['position'], 'left' ); ?>><?php esc_html_e( 'Left', 'charityheart' ); ?></option>
                <option value="right" <?php selected( $instance['position'], 'right' ); ?>><?php esc_html_e( 'Right', 'charityheart' ); ?></option>
            </select>
        </p>
<?php
    }
...
register_widget( 'Charityheart_Vertical_Menu' );