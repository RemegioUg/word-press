...
class Charityheart_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'charityheart'),
            array( 'description' => esc_html__( 'Socials for website.', 'charityheart' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'charityheart-script-admin-js', get_template_directory_uri().'/js/admin/admin.js', array( 'jquery' ), APUS_FRAMEWORK_VERSION, true );
    }
...
register_widget( 'Charityheart_Socials_Widget' );