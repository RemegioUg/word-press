...
class Charityheart_Posts extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'apus_posts',
            // Widget name will appear in UI
            esc_html__('Apus Posts Widget', 'charityheart'),
            // Widget description
            array( 'description' => esc_html__( '', 'charityheart' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'ids' )); ?>"><?php echo esc_html__( 'Posts:', 'charityheart' ); ?></label>
            <br>
...
register_widget( 'Charityheart_Posts' );