...
class Charityheart_Single_Image extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_single_image',
            esc_html__('Apus Single Image Widget', 'charityheart'),
            array( 'description' => esc_html__( 'Show single image', 'charityheart' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e( 'Description:', 'charityheart' ); ?></label>
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'charityheart' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'charityheart' ); ?></label>
...
register_widget( 'Charityheart_Single_Image' );