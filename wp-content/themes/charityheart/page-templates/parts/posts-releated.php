<?php
    $relate_count = charityheart_get_config('number_blog_releated', 3);
    $relate_columns = charityheart_get_config('releated_blog_columns', 3);
...
<div class="related-posts">
    <div class="widget">
        <h4 class="widget-title">
            <span><?php esc_html_e( 'Related Posts', 'charityheart' ); ?></span>
        </h4>
