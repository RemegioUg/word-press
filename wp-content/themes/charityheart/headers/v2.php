        ...
        <div class="container">
            <div class="pull-left">
                <div class="logo-in-theme ">
                    <?php get_template_part( 'page-templates/parts/logo-red' ); ?>
                </div>
            </div>
            
             <?php if ( charityheart_get_config('top_contact_info_v2') ): ?>
                <div class="pull-right top-header-right">
                    <div class="pull-right">
                        <?php echo trim(charityheart_get_config('top_contact_info_v2')); ?>
                    </div>
                </div>
            <?php endif; ?>
