...
<head>
	...
	if ( !function_exists( 'wp_site_icon' ) ) {
		$favicon = charityheart_get_config('media-favicon');
...
<body <?php body_class(); ?>>
<?php if ( charityheart_get_config('preload') ) { ?>
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php $header = apply_filters( 'charityheart_get_header_layout', charityheart_get_config('header_type') );
		if ( empty($header) ) {
			$header = 'v1';
		}
	?>
